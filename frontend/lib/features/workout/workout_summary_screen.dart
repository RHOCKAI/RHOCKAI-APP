...
class _WorkoutSummaryScreenState extends State<WorkoutSummaryScreen> {
        ...
        child: Stack(
          ...
          children: [
            SingleChildScrollView(
              ...
              ElevatedButton.icon(
                onPressed: _isCapturing ? null : _shareScorecard,
                icon: _isCapturing 
  ...
  Future<void> _shareScorecard() async {
    ...
    try {
      final RenderRepaintBoundary boundary = _scorecardKey.currentContext!.findRenderObject() as RenderRepaintBoundary;
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Failed to generate scorecard. Please try again.')),
        );
      }
    } finally {
      if (mounted) {
